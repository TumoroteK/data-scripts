select ptf.nom as 'plateforme', b.nom as 'collection_nom', mal.libelle as 'maladie_libelle', coalesce(mal.code, '') as 'maladie_code', echtype.type as 'type_echantillon', count(distinct ech.echantillon_id) as nb_echantillons, count(distinct mal.patient_id) as nb_patients_distincts  
...
where 
	...
	and b.DEFMALADIES=1 and mal.libelle <> 'INDETERMINEE' and ech.objet_statut_id = 1 and ptf.nom in ('CRB EST', 'CRB SUD', 'CRB NORD') 
