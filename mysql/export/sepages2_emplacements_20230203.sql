select 'echanid', 'codeechantillon', 'typedechantillon', 'quantite', 'quantite_initiale', 'unite', 'datedestockage', 'delaidecongelation', 'operateur', 'temp_stockage', 'statutstockage', 'emplacement', 'mode_preparation', 'date_heure_saisie', 'utilisateur_saisie', 'ktemperatureurine', 'kvalrefractometre', 'kcommentaire', 'kdecongelation', 'prelid', 'prelid',
