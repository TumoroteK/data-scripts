...
BEGIN
	...
	insert into IMPORT_TEMPLATE select @i:=@i+1, _banqueId, i.nom, i.description, i.is_editable, i.derive_parent_entite_id, i.is_update, _importId from IMPORT_TEMPLATE i where i.import_template_id = _importId;
