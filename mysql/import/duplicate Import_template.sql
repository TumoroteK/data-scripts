...
insert into IMPORT_TEMPLATE select @i:=@i+1, b.banque_id, i.nom, i.description, i.is_editable, i.derive_parent_entite_id, i.is_update, 2 from BANQUE b, IMPORT_TEMPLATE i where i.import_template_id = 2 and b.banque_id != 6 order by b.banque_id;
...
select o.import_template_id, o.import_colonne_id, c.champ_id, c2.champ_id from IMPORT_COLONNE o join CHAMP c on c.champ_id = o.champ_id join CHAMP c2 on c2.champ_annotation_id = c.champ_annotation_id and c2.champ_entite_id = c.champ_entite_id where o.import_template_id = c2.import_template_id;
...
BEGIN
	...
	insert into IMPORT_TEMPLATE select @i:=@i+1, _banqueId, i.nom, i.description, i.is_editable, i.derive_parent_entite_id, i.is_update, _importId from BANQUE b, IMPORT_TEMPLATE i where i.import_template_id = _importId;
